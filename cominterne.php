...
<body id="home" class="cominterne">
      ...
      <header id="header">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
						...
						<li class="scroll"><a href="transformation.php">Transformation de l'administration</a></li>
                        <li class="scroll active"><a href="cominterne.php">Com'Interne</a></li>                       
                    </ul>
                </div>
            </div><!--/.container-->
        </nav><!--/nav-->
	   ...
	   <section id="main-slider">
        <div>
            <div class="item" style="background-image: url(images/slider/cominterne.jpg);">
            </div><!--/.item-->
            ...
            <div class="row text-center">
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        <div class="animated-number" data-digit="17500" data-duration="3000"></div>
                        <strong>INVITATIONS DISTRIBUEES</strong>
                    </div>
                </div>
                 <div class="col-sm-3 col-xs-6">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        <div class="animated-number" data-digit="1750" data-duration="3000"></div>
                        <strong>COMPTES DOMUS CREES</strong>
                    </div>
                </div>
				      <div class="col-sm-3 col-xs-6">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        <div class="animated-number" data-digit="125" data-duration="3000"></div>
                        <strong>PUBLICATIONS PAR AN</strong>
                    </div>
                </div>
				 <div class="col-sm-3 col-xs-6">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <div class="animated-number" data-digit="47" data-duration="3000"></div>
                        <strong>EVENEMENTS PAR AN</strong>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="work-process">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Notre travail</h2>
    ...
    <section id="portfolio">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">MEDIAS</h2>
                <p class="text-center wow fadeInDown">Retrouvez toutes les photos et videos</p>
            </div>
    ...
    <section id="blog">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Dernières infos</h2>
                <p class="text-center wow fadeInDown">Voici les dernières publications mises en ligne</p>
            </div>
...
<div align="center">
  <table width='950px'>
		...
		</tr><tr><tr><td><font color="#000000"><b>29/04/2021</b></font></td><td><img src="/wp-content/uploads/images/PDF.png"></td><td><a href="./laccent//L'Accent n°3 - Avril 2021.pdf" target=\"_blank\">L'Accent n°3 - Avril 2021.pdf</a></td></tr><tr><td><font color="#000000"><b>30/03/2021</b></font></td><td><img src="/wp-content/uploads/images/PDF.png"></td><td><a href="./laccent//L'Accent n°2 - Mars 2021.pdf" target=\"_blank\">L'Accent n°2 - Mars 2021.pdf</a></td></tr><tr><td><font color="#000000"><b>27/02/2021</b></font></td><td><img src="/wp-content/uploads/images/PDF.png"></td><td><a href="./laccent//L'Accent n°1 - Fevrier 2021.pdf" target=\"_blank\">L'Accent n°1 - Fevrier 2021.pdf</a></td></tr></table></div>			
			</div>
      ...
      <section id="get-in-touch">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Gardons le contact</h2>
                <p class="text-center wow fadeInDown">Le service de la Com'interne reste à votre service !</p>
            </div>
        </div>
    </section><!--/#get-in-touch-->

<section id="contact">
 							  <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d260497.67859205327!2d7.25085176824086!3d43.83261134991632!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sfr!2sfr!4v1621947063427!5m2!1sfr!2sfr" width="1920" height="1080" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                ...
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-8">
                        <div class="contact-form">
                            ...
                            <address>
                              <strong>Communication Interne NCA</strong><br>
                              3 rue Raoul Bosio<br>
                              06364 Nice Cedex 4<br>
                              <abbr title="Phone">Tel. :</abbr> 04 97 13 22 35
                            </address>
							 ...
							 <form  method="post" action="sendemail.php">
								...
								<div class="form-group">
                                    <input type="text" name="user" class="form-control" value="0_FBaby" required readonly>
                                </div>
                                <div class="form-group">
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2021 Communication Interne NCA
                </div>
                <div class="col-sm-6">
